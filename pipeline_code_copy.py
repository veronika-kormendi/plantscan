...
def preprocess_image(image_path): # running img tasks
    ...
    gscale_img_path = img.colour_to_greyscale(jpg_filepath, GREYSCALE_FOLDER) # greyscale conversion
...
def process_cropped_image(cropped_img_path):
    ...
    # eval.evaluate_preprocessed(cleaned_extracted_path, CLEANED_FOLDER_PATH, "preprocessed_metrics_singe.csv")
