...
test_gt_file = 'C:\\Users\\veron\\PycharmProjects\\plantscan\\annotation\\IMG_7476_cropped.txt' # temporarily I use this path for testing
def save_and_ocr():
    ...
    if extracted_txt is not None:
        count_w_char(extracted_txt)
        count_w_char(test_gt_file)
