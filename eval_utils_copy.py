...
def evaluate_preprocessed(ocr_path, folder_path, output_csv="preprocessed_metrics.csv"):
    results = []
    input_txt_file = os.path.basename(ocr_path)
...
# #=--------------------
# def evaluate_postprocessed(, output_csv="postprocessed_metrics.csv"):
#     # if not input_txt_file.endswith("postprocessed.txt"):
#     results = []
#     input_txt_file = os.path.basename(input_txt_file)
#
